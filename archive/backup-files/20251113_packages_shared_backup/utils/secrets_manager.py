"""
AWS Secrets Manager utility for centralized secret management
...
class SecretsManager:
    ...
    def __init__(
        ...
        Args:
            ...
            secret_prefix: Prefix for secret names (default: "argo-alpine")
        """
    ...
    def _get_secret_name(self, key: str, service: Optional[str] = None) -> str:
        ...
        Args:
            key: Secret key name
            service: Optional service name (e.g., "argo", "alpine-backend")
        
        Returns:
            Full secret name (e.g., "argo-alpine/argo/redis-password")
        """
        if service:
