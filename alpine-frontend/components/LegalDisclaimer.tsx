...
export default function LegalDisclaimer() {
  return (
    <section className="bg-alpine-semantic-error/10 border-y-2 border-alpine-semantic-error/30 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-start space-x-4 mb-6">
            ...
            <h2 className="text-2xl font-bold text-alpine-semantic-error">
              ⚠️ IMPORTANT DISCLAIMERS - READ CAREFULLY
            </h2>
          </div>

          <div className="space-y-4 text-alpine-text-primary leading-relaxed">
            <p>
              <strong className="text-alpine-semantic-error">Alpine Analytics LLC</strong> provides trading
              signals for educational and informational purposes only. We are{' '}
              <strong>NOT registered investment advisors</strong>.
            </p>

            <div>
              <strong className="text-alpine-text-primary">Trading Risk:</strong> Trading involves substantial
              risk of loss. You can lose more than your initial investment. Past performance does
              not guarantee future results.
            </div>

            <div>
              <strong className="text-alpine-text-primary">Backtest Limitations:</strong> Performance data is
            ...
            <div>
              <strong className="text-alpine-text-primary">No Guarantees:</strong> We make no guarantees of
            ...
            <div>
              <strong className="text-alpine-text-primary">Your Responsibility:</strong> You are solely
              responsible for your trading decisions. Consult a licensed financial advisor before
              trading.
            </div>

            <div>
              <strong className="text-alpine-text-primary">Company Disclosure:</strong> Alpine Analytics LLC is
            ...
            <div>
              <strong className="text-alpine-text-primary">Pricing:</strong> Current pricing is promotional
              and subject to change. Annual plans lock in rates for the subscription term.
            </div>

            <div>
              <strong className="text-alpine-text-primary">Geographic Restrictions:</strong> Service may not
