      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Quote className="w-8 h-8 text-alpine-neon-pink mb-4" />
              <p className="text-alpine-text-primary text-lg mb-6 leading-relaxed">
                "{testimonial.quote}"
              </p>
              <div>
                <div className="font-semibold text-alpine-text-primary ">{testimonial.author}</div>
                <div className="text-alpine-text-secondary text-sm">{testimonial.role}</div>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-center text-alpine-text-secondary text-sm italic max-w-3xl mx-auto"
        >
