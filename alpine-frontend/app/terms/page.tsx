  ...
  return (
    <div className="min-h-screen bg-alpine-black-primary text-alpine-text-primary ">
      <div className="container mx-auto px-6 py-20 max-w-4xl">
        <h1 className="text-4xl font-display font-bold mb-8 text-alpine-semantic-success">Terms of Service</h1>
        ...
        <div className="space-y-8 text-alpine-text-secondary">
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">1. Acceptance of Terms</h2>
            <p>By accessing and using Alpine Analytics ("Service"), you accept and agree to be bound by these Terms of Service.</p>
          </section>

          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">2. Service Description</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">3. Risk Disclosure</h2>
            <p className="font-bold text-alpine-semantic-error mb-2">TRADING INVOLVES SUBSTANTIAL RISK OF LOSS.</p>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">4. Backtest Disclosure</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">5. Subscription & Payment</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">6. Refund Policy</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">7. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">8. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-alpine-text-primary mb-4">9. Contact</h2>
            <p>For questions about these Terms, contact: <a href="mailto:alpine.signals@proton.me" className="text-alpine-semantic-success hover:underline">alpine.signals@proton.me</a></p>
          </section>
        </div>
