...
### 17. Prop Firm Trading Setup Guide (Argo Capital Only)
**File**: `../PROP_FIRM_SETUP_GUIDE.md`

**Purpose**: Complete guide to prop firm trading system with account separation

**Covers**:
- Prop firm account configuration and separation
...
**Use When**: Setting up prop firm trading, configuring prop firm accounts, understanding account separation

**Note:** Prop firm trading is Argo Capital only and completely isolated from regular trading accounts.
