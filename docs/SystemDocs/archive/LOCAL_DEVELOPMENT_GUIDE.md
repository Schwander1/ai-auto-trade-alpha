...
### 4. Setup Agentic Features (Optional)
...
# Set API key (if using Claude API)
...
**See:** `docs/AGENTIC_SETUP_GUIDE.md` for complete setup instructions

### 5. Test Trade (Optional)
...
3. **Use Agentic Features (Optional)**
   ```bash
