"""
Alpine Analytics LLC - AWS Secrets Manager utility
...
class SecretsManager:
    ...
    def __init__(
        ...
        secret_prefix: str = "alpine-analytics"  # Alpine-specific prefix
    ):
        """
        ...
        Args:
            ...
            secret_prefix: Prefix for secret names (default: "alpine-analytics")
        """
    ...
    def _get_secret_name(self, key: str, service: Optional[str] = None) -> str:
        ...
        Args:
            key: Secret key name
            service: Optional service name (e.g., "alpine-backend")
        
        Returns:
            Full secret name (e.g., "alpine-analytics/stripe/secret_key")
        """
        if service:
    ...
    def get_secret(
        ...
        if not aws_value and self.secret_prefix == "alpine-analytics" and service:
            ...
            if aws_value:
                logger.info(f"Found secret with old prefix (argo-alpine), consider migrating to new prefix (alpine-analytics)")
